...
class Reclamation
{
    ...
    private ?string $videoCallLink = null;

    #[ORM\Column(nullable: true)]
    private ?\DateTime $videoCallScheduledAt = null;
    ...
    public function getVideoCallLink(): ?string
    {
        return $this->videoCallLink;
    }

    public function setVideoCallLink(?string $videoCallLink): static
    {
    ...
    public function getVideoCallScheduledAt(): ?\DateTime
    {
        return $this->videoCallScheduledAt;
    }

    public function setVideoCallScheduledAt(?\DateTime $videoCallScheduledAt): static
    {
        $this->videoCallScheduledAt = $videoCallScheduledAt;

...
class Produit
{
    ...
    /**
     * Client who added this product (only CLIENT can add/edit/delete).
     */
    ...
    public function getTypemateriau(): ?string { return $this->typemateriau; }
    public function setTypemateriau(?string $typemateriau): static { $this->typemateriau = $typemateriau; return $this; }
    ...
    public function getImpactecologique(): ?float { return $this->impactecologique; }
    public function setImpactecologique(?float $impactecologique): static { $this->impactecologique = $impactecologique; return $this; }
    ...
    public function setAddedBy(?User $addedBy): static { $this->addedBy = $addedBy; return $this; }
    ...
    {
        if ($this->propositions->removeElement($proposition) && $proposition->getProduit() === $this) {

...
class ProduitType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('quantite', IntegerType::class, ['attr' => ['min' => 0], 'required' => true])
            ->add('origine', null, ['required' => true])
            ->add('impactecologique', null, ['required' => true])
            ...
            ->add('description', TextareaType::class, ['attr' => ['minlength' => 10], 'required' => true])

 ...
 */
final class Version20260219214657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD last_notification_sent DATETIME DEFAULT NULL, CHANGE descripition descripition VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation DROP last_notification_sent, CHANGE descripition descripition TEXT DEFAULT NULL');
    }
}

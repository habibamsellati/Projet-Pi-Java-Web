...
final class Version20260218120000 extends AbstractMigration
{
    ...
    {
        return 'Ajoute les likes des articles (client -> article artisan)';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('CREATE TABLE article_like (article_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_DF2DB4E07294869C (article_id), INDEX IDX_DF2DB4E0A76ED395 (user_id), PRIMARY KEY(article_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
